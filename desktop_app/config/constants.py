...
class Colors:
    ...
    BORDER_INPUT:  str = "#3A3A3A" 
    BORDER_FOCUS:  str = "#E85D3A"
    ...
    BTN_CONNECT_BG:    str = "#E85D3A"
    BTN_CONNECT_HOV:   str = "#D04E2E"
    BTN_CONNECT_PRESS: str = "#B04028"
    BTN_CONNECT_DIM:   str = "#4A2A2A"
